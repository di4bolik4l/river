...
function AnimeDetail({user}) {
    ...
    return (
        <div class="grid grid-cols-2 gap-2">
            ...
            <ul>
                <ul>{'Watch Here: '}
                    {animeDetailObj.netflix ? <a href={animeDetailObj.netflix}>Netflix </a> : null}
                    {animeDetailObj.prime ? <a href={animeDetailObj.prime}>Amazon Prime </a> : null}
                    {animeDetailObj.hulu ? <a href={animeDetailObj.hulu}>Hulu </a> : null}
                    {animeDetailObj.crunchyroll ? <a href={animeDetailObj.cruncyroll}>Cruncyroll </a> : null}
                </ul>
            </ul>
